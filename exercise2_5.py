...
def main():
    ...
    for i in range (0, total_runs):
        ...
        for j in range(0, num_bandits):
            bandits.append(Bandit(0.0, std, 0, 0.0, 0.0))
...
def plot_figures(total_runs, total_steps):
    ...
    np.savetxt("sample_avg_reward_sudden.csv", avg_reward_averages, delimiter=",")
    np.savetxt("sample_avg_percent_sudden.csv", avg_percent_optimal, delimiter=",")
